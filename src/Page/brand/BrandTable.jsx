...
import AddBrandForm from '../brand/AddBrandForm';
...
const ProductList = () => {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:8080/api/brands/get-all') // Thay đổi URL nếu cần
    ...
    const handleDelete = (id) => {
        ...
        fetch(`http://localhost:8080/api/brands/delete/${id}`, {
            method: 'DELETE',
        })
            .then(response => {
                if (response.ok) {
    ...
    return (
        <div className="container mx-auto p-4">
            ...
            {showAddForm && <AddBrandForm onAddProduct={handleAddProduct} />}
