...
import AddCategoriesForm from '../categories/AddCategoriesForm';
...
const CategoriesList = () => {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:8080/api/categories/get-all') // Thay đổi URL nếu cần
    ...
    return (
        <div className="container mx-auto p-4">
            ...
            {showAddForm && <AddCategoriesForm onAddProduct={handleAddProduct} />}
